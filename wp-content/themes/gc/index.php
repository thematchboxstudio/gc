							...
							<div id="section-1" class="services page-section scrolleffect" style="background-image:url(<?php echo $background_image; ?>);">
					    		...
					    		<div class="section-title active">
					    			...
					    			<div class="button-wrap">
					    				<a href="<?php echo home_url(); ?>/#services"><div class="button more-info">Our <?php echo $title; ?></div></a>
					    			</div>
						...
						<a class="nav-highlight-target" name="section2"></a>
				    		<div class="section-title active">
				    			...
				    			<div class="button-wrap">
				    				...
				    				<a href="<?php echo home_url(); ?>/#our-work"><div class="button gallery-activate">Gallery</div></a>
				    			</div>
					    ...
					    <section class="facility page-section">
					    	...
					    	<div class="section-title active">
					    		...
					    		<div class="button-wrap">
				    				...
				    				<div class="button gallery-activate"><a href="<?php echo home_url(); ?>/#facility">Gallery</a></div>
				    			</div>
					    	</div>
